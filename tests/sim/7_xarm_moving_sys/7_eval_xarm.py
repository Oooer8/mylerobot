...
pretrained_policy_path = Path("outputs/train/xarm_lift")
...
output_directory = Path("outputs/videos/xarm_lift")
...
for episode in range(max_episodes):
    ...
    while not done:
        ...
        if done:
            if len(frames) > 0:
                video_path = f"{output_directory}/xarm_episode_{episode}.mp4"
