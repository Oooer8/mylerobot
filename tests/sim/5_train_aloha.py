...
def train():
    output_directory = Path("outputs/train/aloha_transfer_cube")
    ...
    dataset_metadata = LeRobotDatasetMetadata("lerobot/aloha_sim_transfer_cube_scripted_image")
    ...
    full_dataset = LeRobotDataset("lerobot/aloha_sim_transfer_cube_scripted_image", 
